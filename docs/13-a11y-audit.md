...
| 前景 | 背景 | 对比度 | WCAG AA (4.5:1) |
|---|---|---|---|
| `--fg` `#e8e9f3` | `--bg-0` `#0a0a1a` | **15.4:1** | ✅ AAA |
| `--fg-mute` `#9ea4c4` | `--bg-0` | **6.2:1** | ✅ AA |
| `--accent` `#7df9ff` | `--bg-0` | **11.8:1** | ✅ AAA |
| `--warn` `#ffc857` | `--bg-0` | **9.5:1** | ✅ AAA |
| `--accent-2` `#b388ff` | `--bg-0` | **6.0:1** | ✅ AA |
| `--success` `#6bd968` | `--bg-0` | **8.2:1** | ✅ AAA |
| `--danger` `#ff5d6c` | `--bg-0` | **4.7:1** | ✅ AA |

**结论**：所有颜色对深色背景均过 WCAG AA（4.5:1）· 大部分达 AAA（7:1）· 无需调整。
...
| 🟢 P2 | 颜色对比度实测（已理论验证·建议上 https://wave.webaim.org/ 跑实测） | 15 min | 标准验证 |
